...
RUN curl -L -o /usr/local/bin/consul-template https://github.com/hashicorp/consul-template/releases/download/v0.3.0/consul-template_0.3.0_linux_amd64.tar.gz && \
