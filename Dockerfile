...
RUN curl -L -o /usr/local/bin/consul-template https://github.com/hashicorp/consul-template/releases/download/v0.1.0/consul-template_0.1.0_linux_amd64.tar.gz && \
